# Skill entry: score, rank, and build scoring configs from JD structured data.
...
# Builds a scorer with the default on-disk taxonomy.
def _build_default_scorer() -> ScorerService:
    taxonomy = SkillTaxonomyLoader(str(taxonomy_yaml_path()))
    taxonomy.load()
